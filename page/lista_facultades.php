...
<div class="table-wrapper">
    <div class="table-title">
        <div class="row">
            <div class="col-md-6"><h2>Listado de <b>Facultades</b></h2></div>           
            <div class="col-md-2">
                <a href=".\portal.php" class="btn btn-outline-dark"><i class="icon-home"></i> Inicio</a>
            </div>
             <div class="col-md-4">
                <a href=".\alta_facultad.php" class="btn btn-outline-success"><i class="icon-circle-with-plus"></i> Alta Facultad</a>
            </div>
...
<!-- INICIO FILTROS -->
    <div id="filtros"> Selecciona el filtro deseado
        <form class="row" action="lista_facultades.php" method="post">
            <div class="col-sm-2">
 ...
 <!--FILTROS FIN-->   
    ...
    ?>
        <tr>
            ...
            <td class="numero">
            <a href="modifica_facultad.php?id=<?php echo $id;?>" class="edit" title="Editar" data-toggle="tooltip">
                <i class="icon-edit"></i>
            </a>
<?php if ($_SESSION['userid']==1) { ?>            
            <a href="quita_facultad.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip" onclick="return Confirmation()">
